...
public class Camera1 extends CameraImpl {
    ...
    Camera1(CameraListener callback, PreviewImpl preview) {
        ...
        Log.d("CameraView","Thread: " + Thread.currentThread() +", cam1() constructor");
    ...
    @Override
    void start() {
        Log.d("CameraView","Thread: " + Thread.currentThread() +", start() started");
        setFacing(mFacing);
        openCamera();
        if (mPreview.isReady()) setupPreview();
        mCamera.startPreview();
        Log.d("CameraView","Thread: " + Thread.currentThread() +", start() ended");
    }
    ...
    void setFacing(@Facing int facing) {
        ...
        Log.d("CameraView","Thread: " + Thread.currentThread() +", setFacing() started");
        ...
        Log.d("CameraView","Thread: " + Thread.currentThread() +", setFacing() ended");
    }

    @Override
    void setFlash(@Flash int flash) {

        Log.d("CameraView","Thread: " + Thread.currentThread() +", setFlash() started");
        ...
        Log.d("CameraView","Thread: " + Thread.currentThread() +", setFlash() ended");
    }
    ...
    private void openCamera() {
        ...
        Log.d("CameraView","Camera Created");
    ...
    private void adjustCameraParameters() {
        ...
        Log.d("CameraView","Thread: " + Thread.currentThread() +", adjustCameraParameters() started");
        ...
        Log.d("CameraView","Thread: " + Thread.currentThread() +", adjustCameraParameters() ended");
    }
